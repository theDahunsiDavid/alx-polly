...
import { deletePoll, togglePollActive } from "@/lib/actions/polls"
...
export function PollDetailClient({ poll, isOwner }: PollDetailClientProps) {
          ...
          {isOwner && (
            <>
              ...
              <form action={togglePollActive}>
                ...
                <input type="hidden" name="nextActive" value={(!poll.isActive).toString()} />
